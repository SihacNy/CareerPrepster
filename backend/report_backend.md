...
| **Security** | Helmet, bcryptjs, jsonwebtoken | Secure headers, password hashing, HttpOnly JWT cookies |
...
1. **`users`**:
   ...
   - `passwordHash` (Bcrypt Hash VARCHAR)
   - `name` (VARCHAR)
