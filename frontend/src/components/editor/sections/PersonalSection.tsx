    ...
    <div id="section-personal" className="bg-white p-5 rounded-xl border border-slate-200 mb-5 scroll-mt-24 transition-all">
      ...
      {isSectionOpen && (
        ...
        <div>
          ...
          <input
            ...
            className="w-full text-sm text-slate-900 bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 focus:ring-1 focus:ring-sky-500 focus:border-sky-500 outline-none"
          />
        </div>
        ...
        {/* GitHub */}
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1.5">GitHub / Portfolio</label>
          <input
            type="text"
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          className="w-full text-sm text-slate-900 bg-white border border-slate-200 rounded-lg p-3 focus:ring-1 focus:ring-sky-500 focus:border-sky-500 outline-none leading-relaxed"
        />
      </div>
        </>
      )}
